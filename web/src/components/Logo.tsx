...
export function Logo({ href = "/" }: { href?: string }) {
  return (
    ...
    >
      <span className="relative inline-flex h-6 w-6 items-center justify-center rounded-md bg-brand text-[#04140d] shadow-[0_0_0_1px_rgba(52,211,153,0.4),0_8px_30px_-12px_rgba(52,211,153,0.6)]">
